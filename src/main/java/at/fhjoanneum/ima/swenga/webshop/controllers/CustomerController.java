...
import at.fhjoanneum.ima.swenga.webshop.entities.Address;
...
public class CustomerController implements Serializable {
    ...
    @EJB 
    private at.fhjoanneum.ima.swenga.webshop.facades.CustomerFacade ejbFacade;
    ...
    public void addAddress() {
        selected.getAddresses().add(newAddress);
        newAddress = null;
    }
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("locales/Bundle").getString("CustomerCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("locales/Bundle").getString("CustomerUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("locales/Bundle").getString("CustomerDeleted"));
        if (!JsfUtil.isValidationFailed()) {
            selected = null;
            items = null;
        }
